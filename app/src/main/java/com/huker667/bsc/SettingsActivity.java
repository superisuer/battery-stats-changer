...
public class SettingsActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		binding.linear3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				i.setData(Uri.parse("https://github.com/superisuer/battery-stats-changer\n"));
				startActivity(i);
			}
		});
		...
		binding.linear4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				i.setAction(Intent.ACTION_VIEW);
				i.setData(Uri.parse("https://t.me/hukerass"));
				startActivity(i);
			}
		});
	}
	...
	private void initializeLogic() {
		binding.textview10.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/jetbrainsmono.ttf"), 0);
	}
